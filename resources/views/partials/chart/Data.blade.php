...
<script>
    const dataOption = {
        // enable and customize data labels using the following example, learn more from here: https://ApexChartsData.com/docs/datalabels/
        dataLabels: {
            enabled: true,
            // offsetX: 10,
            style: {
    ...
    if (document.getElementById("data-labels-chart") && typeof ApexCharts !== 'undefined') {
        const chart = new ApexCharts(document.getElementById("data-labels-chart"), dataOption);
        chart.render();
    }
</script>
