<div class="h-auto w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
...
<script>
    ...
    if (document.getElementById("line-chart") && typeof ApexCharts !== 'undefined') {
        const chart = new ApexCharts(document.getElementById("line-chart"), lineOption);
        chart.render();
    }
</script>
